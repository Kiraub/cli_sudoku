...
solver(HintAmount, Sample) :-
    ...
    (Length>1->(sub_atom(Sample, 1,1,_,ABE),not(empty(ABE))->AB=ABE;ABE='x');ABE='x'),
    (Length>2->(sub_atom(Sample, 2,1,_,ACE),not(empty(ACE))->AC=ACE;ACE='x');ACE='x'),
    (Length>3->(sub_atom(Sample, 3,1,_,ADE),not(empty(ADE))->AD=ADE;ADE='x');ADE='x'),
    (Length>4->(sub_atom(Sample, 4,1,_,AEE),not(empty(AEE))->AE=AEE;AEE='x');AEE='x'),
    (Length>5->(sub_atom(Sample, 5,1,_,AFE),not(empty(AFE))->AF=AFE;AFE='x');AFE='x'),
    (Length>6->(sub_atom(Sample, 6,1,_,AGE),not(empty(AGE))->AG=AGE;AGE='x');AGE='x'),
    (Length>7->(sub_atom(Sample, 7,1,_,AHE),not(empty(AHE))->AH=AHE;AHE='x');AHE='x'),
    (Length>8->(sub_atom(Sample, 8,1,_,AIE),not(empty(AIE))->AI=AIE;AIE='x');AIE='x'),
    (Length>9->(sub_atom(Sample, 9,1,_,BAE),not(empty(BAE))->BA=BAE;BAE='x');BAE='x'),
    (Length>10->(sub_atom(Sample, 10,1,_,BBE),not(empty(BBE))->BB=BBE;BBE='x');BBE='x'),
    (Length>11->(sub_atom(Sample, 11,1,_,BCE),not(empty(BCE))->BC=BCE;BCE='x');BCE='x'),
    (Length>12->(sub_atom(Sample, 12,1,_,BDE),not(empty(BDE))->BD=BDE;BDE='x');BDE='x'),
    (Length>13->(sub_atom(Sample, 13,1,_,BEE),not(empty(BEE))->BE=BEE;BEE='x');BEE='x'),
    (Length>14->(sub_atom(Sample, 14,1,_,BFE),not(empty(BFE))->BF=BFE;BFE='x');BFE='x'),
    (Length>15->(sub_atom(Sample, 15,1,_,BGE),not(empty(BGE))->BG=BGE;BGE='x');BGE='x'),
    (Length>16->(sub_atom(Sample, 16,1,_,BHE),not(empty(BHE))->BH=BHE;BHE='x');BHE='x'),
    (Length>17->(sub_atom(Sample, 17,1,_,BIE),not(empty(BIE))->BI=BIE;BIE='x');BIE='x'),
    (Length>18->(sub_atom(Sample, 18,1,_,CAE),not(empty(CAE))->CA=CAE;CAE='x');CAE='x'),
    (Length>19->(sub_atom(Sample, 19,1,_,CBE),not(empty(CBE))->CB=CBE;CBE='x');CBE='x'),
    (Length>20->(sub_atom(Sample, 20,1,_,CCE),not(empty(CCE))->CC=CCE;CCE='x');CCE='x'),
    (Length>21->(sub_atom(Sample, 21,1,_,CDE),not(empty(CDE))->CD=CDE;CDE='x');CDE='x'),
    (Length>22->(sub_atom(Sample, 22,1,_,CEE),not(empty(CEE))->CE=CEE;CEE='x');CEE='x'),
    (Length>23->(sub_atom(Sample, 23,1,_,CFE),not(empty(CFE))->CF=CFE;CFE='x');CFE='x'),
    (Length>24->(sub_atom(Sample, 24,1,_,CGE),not(empty(CGE))->CG=CGE;CGE='x');CGE='x'),
    (Length>25->(sub_atom(Sample, 25,1,_,CHE),not(empty(CHE))->CH=CHE;CHE='x');CHE='x'),
    (Length>26->(sub_atom(Sample, 26,1,_,CIE),not(empty(CIE))->CI=CIE;CIE='x');CIE='x'),
    (Length>27->(sub_atom(Sample, 27,1,_,DAE),not(empty(DAE))->DA=DAE;DAE='x');DAE='x'),
    (Length>28->(sub_atom(Sample, 28,1,_,DBE),not(empty(DBE))->DB=DBE;DBE='x');DBE='x'),
    (Length>29->(sub_atom(Sample, 29,1,_,DCE),not(empty(DCE))->DC=DCE;DCE='x');DCE='x'),
    (Length>30->(sub_atom(Sample, 30,1,_,DDE),not(empty(DDE))->DD=DDE;DDE='x');DDE='x'),
    (Length>31->(sub_atom(Sample, 31,1,_,DEE),not(empty(DEE))->DE=DEE;DEE='x');DEE='x'),
    (Length>32->(sub_atom(Sample, 32,1,_,DFE),not(empty(DFE))->DF=DFE;DFE='x');DFE='x'),
    (Length>33->(sub_atom(Sample, 33,1,_,DGE),not(empty(DGE))->DG=DGE;DGE='x');DGE='x'),
    (Length>34->(sub_atom(Sample, 34,1,_,DHE),not(empty(DHE))->DH=DHE;DHE='x');DHE='x'),
    (Length>35->(sub_atom(Sample, 35,1,_,DIE),not(empty(DIE))->DI=DIE;DIE='x');DIE='x'),
    (Length>36->(sub_atom(Sample, 36,1,_,EAE),not(empty(EAE))->EA=EAE;EAE='x');EAE='x'),
    (Length>37->(sub_atom(Sample, 37,1,_,EBE),not(empty(EBE))->EB=EBE;EBE='x');EBE='x'),
    (Length>38->(sub_atom(Sample, 38,1,_,ECE),not(empty(ECE))->EC=ECE;ECE='x');ECE='x'),
    (Length>39->(sub_atom(Sample, 39,1,_,EDE),not(empty(EDE))->ED=EDE;EDE='x');EDE='x'),
    (Length>40->(sub_atom(Sample, 40,1,_,EEE),not(empty(EEE))->EE=EEE;EEE='x');EEE='x'),
    (Length>41->(sub_atom(Sample, 41,1,_,EFE),not(empty(EFE))->EF=EFE;EFE='x');EFE='x'),
    (Length>42->(sub_atom(Sample, 42,1,_,EGE),not(empty(EGE))->EG=EGE;EGE='x');EGE='x'),
    (Length>43->(sub_atom(Sample, 43,1,_,EHE),not(empty(EHE))->EH=EHE;EHE='x');EHE='x'),
    (Length>44->(sub_atom(Sample, 44,1,_,EIE),not(empty(EIE))->EI=EIE;EIE='x');EIE='x'),
    (Length>45->(sub_atom(Sample, 45,1,_,FAE),not(empty(FAE))->FA=FAE;FAE='x');FAE='x'),
    (Length>46->(sub_atom(Sample, 46,1,_,FBE),not(empty(FBE))->FB=FBE;FBE='x');FBE='x'),
    (Length>47->(sub_atom(Sample, 47,1,_,FCE),not(empty(FCE))->FC=FCE;FCE='x');FCE='x'),
    (Length>48->(sub_atom(Sample, 48,1,_,FDE),not(empty(FDE))->FD=FDE;FDE='x');FDE='x'),
    (Length>49->(sub_atom(Sample, 49,1,_,FEE),not(empty(FEE))->FE=FEE;FEE='x');FEE='x'),
    (Length>50->(sub_atom(Sample, 50,1,_,FFE),not(empty(FFE))->FF=FFE;FFE='x');FFE='x'),
    (Length>51->(sub_atom(Sample, 51,1,_,FGE),not(empty(FGE))->FG=FGE;FGE='x');FGE='x'),
    (Length>52->(sub_atom(Sample, 52,1,_,FHE),not(empty(FHE))->FH=FHE;FHE='x');FHE='x'),
    (Length>53->(sub_atom(Sample, 53,1,_,FIE),not(empty(FIE))->FI=FIE;FIE='x');FIE='x'),
    (Length>54->(sub_atom(Sample, 54,1,_,GAE),not(empty(GAE))->GA=GAE;GAE='x');GAE='x'),
    (Length>55->(sub_atom(Sample, 55,1,_,GBE),not(empty(GBE))->GB=GBE;GBE='x');GBE='x'),
    (Length>56->(sub_atom(Sample, 56,1,_,GCE),not(empty(GCE))->GC=GCE;GCE='x');GCE='x'),
    (Length>57->(sub_atom(Sample, 57,1,_,GDE),not(empty(GDE))->GD=GDE;GDE='x');GDE='x'),
    (Length>58->(sub_atom(Sample, 58,1,_,GEE),not(empty(GEE))->GE=GEE;GEE='x');GEE='x'),
    (Length>59->(sub_atom(Sample, 59,1,_,GFE),not(empty(GFE))->GF=GFE;GFE='x');GFE='x'),
    (Length>60->(sub_atom(Sample, 60,1,_,GGE),not(empty(GGE))->GG=GGE;GGE='x');GGE='x'),
    (Length>61->(sub_atom(Sample, 61,1,_,GHE),not(empty(GHE))->GH=GHE;GHE='x');GHE='x'),
    (Length>62->(sub_atom(Sample, 62,1,_,GIE),not(empty(GIE))->GI=GIE;GIE='x');GIE='x'),
    (Length>63->(sub_atom(Sample, 63,1,_,HAE),not(empty(HAE))->HA=HAE;HAE='x');HAE='x'),
    (Length>64->(sub_atom(Sample, 64,1,_,HBE),not(empty(HBE))->HB=HBE;HBE='x');HBE='x'),
    (Length>65->(sub_atom(Sample, 65,1,_,HCE),not(empty(HCE))->HC=HCE;HCE='x');HCE='x'),
    (Length>66->(sub_atom(Sample, 66,1,_,HDE),not(empty(HDE))->HD=HDE;HDE='x');HDE='x'),
    (Length>67->(sub_atom(Sample, 67,1,_,HEE),not(empty(HEE))->HE=HEE;HEE='x');HEE='x'),
    (Length>68->(sub_atom(Sample, 68,1,_,HFE),not(empty(HFE))->HF=HFE;HFE='x');HFE='x'),
    (Length>69->(sub_atom(Sample, 69,1,_,HGE),not(empty(HGE))->HG=HGE;HGE='x');HGE='x'),
    (Length>70->(sub_atom(Sample, 70,1,_,HHE),not(empty(HHE))->HH=HHE;HHE='x');HHE='x'),
    (Length>71->(sub_atom(Sample, 71,1,_,HIE),not(empty(HIE))->HI=HIE;HIE='x');HIE='x'),
    (Length>72->(sub_atom(Sample, 72,1,_,IAE),not(empty(IAE))->IA=IAE;IAE='x');IAE='x'),
    (Length>73->(sub_atom(Sample, 73,1,_,IBE),not(empty(IBE))->IB=IBE;IBE='x');IBE='x'),
    (Length>74->(sub_atom(Sample, 74,1,_,ICE),not(empty(ICE))->IC=ICE;ICE='x');ICE='x'),
    (Length>75->(sub_atom(Sample, 75,1,_,IDE),not(empty(IDE))->ID=IDE;IDE='x');IDE='x'),
    (Length>76->(sub_atom(Sample, 76,1,_,IEE),not(empty(IEE))->IE=IEE;IEE='x');IEE='x'),
    (Length>77->(sub_atom(Sample, 77,1,_,IFE),not(empty(IFE))->IF=IFE;IFE='x');IFE='x'),
    (Length>78->(sub_atom(Sample, 78,1,_,IGE),not(empty(IGE))->IG=IGE;IGE='x');IGE='x'),
    (Length>79->(sub_atom(Sample, 79,1,_,IHE),not(empty(IHE))->IH=IHE;IHE='x');IHE='x'),
    (Length>80->(sub_atom(Sample, 80,1,_,IIE),not(empty(IIE))->II=IIE;IIE='x');IIE='x'),
    !,
    count_bound(BoundAmount, [AAE,ABE,ACE,ADE,AEE,AFE,AGE,AHE,AIE,BAE,BBE,BCE,BDE,BEE,BFE,BGE,BHE,BIE,CAE,CBE,CCE,CDE,CEE,CFE,CGE,CHE,CIE,DAE,DBE,DCE,DDE,DEE,DFE,DGE,DHE,DIE,EAE,EBE,ECE,EDE,EEE,EFE,EGE,EHE,EIE,FAE,FBE,FCE,FDE,FEE,FFE,FGE,FHE,FIE,GAE,GBE,GCE,GDE,GEE,GFE,GGE,GHE,GIE,HAE,HBE,HCE,HDE,HEE,HFE,HGE,HHE,HIE,IAE,IBE,ICE,IDE,IEE,IFE,IGE,IHE,IIE]),
    (BoundAmount<HintAmount->true;(
    %% bound ende
    %% code anfang
