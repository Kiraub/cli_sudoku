...
(Isatom=yes,sub_atom(Sample, 1,1,_,AB),num(AB))),
AB\=AA,

%% AC
(((Isatom=no;Length<3),num(AC));
(Isatom=yes,sub_atom(Sample, 2,1,_,AC),num(AC))),
AC\=AA,AC\=AB,

%% AD
(((Isatom=no;Length<4),num(AD));
(Isatom=yes,sub_atom(Sample, 3,1,_,AD),num(AD))),
AD\=AA,AD\=AB,AD\=AC,

%% AE
(((Isatom=no;Length<5),num(AE));
(Isatom=yes,sub_atom(Sample, 4,1,_,AE),num(AE))),
AE\=AA,AE\=AB,AE\=AC,AE\=AD,

%% AF
(((Isatom=no;Length<6),num(AF));
(Isatom=yes,sub_atom(Sample, 5,1,_,AF),num(AF))),
AF\=AA,AF\=AB,AF\=AC,AF\=AD,AF\=AE,

%% AG
(((Isatom=no;Length<7),num(AG));
(Isatom=yes,sub_atom(Sample, 6,1,_,AG),num(AG))),
AG\=AA,AG\=AB,AG\=AC,AG\=AD,AG\=AE,AG\=AF,

%% AH
(((Isatom=no;Length<8),num(AH));
(Isatom=yes,sub_atom(Sample, 7,1,_,AH),num(AH))),
AH\=AA,AH\=AB,AH\=AC,AH\=AD,AH\=AE,AH\=AF,AH\=AG,

%% AI
(((Isatom=no;Length<9),num(AI));
(Isatom=yes,sub_atom(Sample, 8,1,_,AI),num(AI))),
...
(Isatom=yes,sub_atom(Sample, 9,1,_,BA),num(BA))),
BA\=AA,
BA\=AB,BA\=AC,
%% BB
(((Isatom=no;Length<11),num(BB));
(Isatom=yes,sub_atom(Sample, 10,1,_,BB),num(BB))),
BB\=BA,
BB\=AB,
BB\=AA,
BB\=AC,
...
(Isatom=yes,sub_atom(Sample, 11,1,_,BC),num(BC))),
BC\=BA,BC\=BB,
BC\=AC,
BC\=AA,BC\=AB,
%% BD
(((Isatom=no;Length<13),num(BD));
(Isatom=yes,sub_atom(Sample, 12,1,_,BD),num(BD))),
BD\=BA,BD\=BB,BD\=BC,
BD\=AD,
BD\=AE,BD\=AF,
%% BE
(((Isatom=no;Length<14),num(BE));
(Isatom=yes,sub_atom(Sample, 13,1,_,BE),num(BE))),
BE\=BA,BE\=BB,BE\=BC,BE\=BD,
BE\=AE,
BE\=AD,BE\=AF,
%% BF
(((Isatom=no;Length<15),num(BF));
(Isatom=yes,sub_atom(Sample, 14,1,_,BF),num(BF))),
BF\=BA,BF\=BB,BF\=BC,BF\=BD,BF\=BE,
BF\=AF,
BF\=AD,BF\=AE,
%% BG
(((Isatom=no;Length<16),num(BG));
(Isatom=yes,sub_atom(Sample, 15,1,_,BG),num(BG))),
BG\=BA,BG\=BB,BG\=BC,BG\=BD,BG\=BE,BG\=BF,
BG\=AG,
BG\=AH,BG\=AI,
%% BH
(((Isatom=no;Length<17),num(BH));
(Isatom=yes,sub_atom(Sample, 16,1,_,BH),num(BH))),
...
(Isatom=yes,sub_atom(Sample, 17,1,_,BI),num(BI))),
...
(Isatom=yes,sub_atom(Sample, 18,1,_,CA),num(CA))),
CA\=AA,CA\=BA,
CA\=AB,CA\=BB,CA\=AC,CA\=BC,
%% CB
(((Isatom=no;Length<20),num(CB));
(Isatom=yes,sub_atom(Sample, 19,1,_,CB),num(CB))),
CB\=CA,
CB\=AB,CB\=BB,
CB\=AA,CB\=BA,CB\=AC,CB\=BC,
%% CC
(((Isatom=no;Length<21),num(CC));
(Isatom=yes,sub_atom(Sample, 20,1,_,CC),num(CC))),
CC\=CA,CC\=CB,
CC\=AC,CC\=BC,
CC\=AA,CC\=BB,
CC\=BA,CC\=AB,
...
(Isatom=yes,sub_atom(Sample, 27,1,_,DA),num(DA))),
DA\=AA,DA\=BA,DA\=CA,

%% DB
(((Isatom=no;Length<29),num(DB));
(Isatom=yes,sub_atom(Sample, 28,1,_,DB),num(DB))),
DB\=DA,
DB\=AB,DB\=BB,DB\=CB,

%% DC
(((Isatom=no;Length<30),num(DC));
(Isatom=yes,sub_atom(Sample, 29,1,_,DC),num(DC))),
DC\=DA,DC\=DB,
DC\=AC,DC\=BC,DC\=CC,

%% DD
(((Isatom=no;Length<31),num(DD));
(Isatom=yes,sub_atom(Sample, 30,1,_,DD),num(DD))),
DD\=DA,DD\=DB,DD\=DC,
DD\=AD,DD\=BD,DD\=CD,
DD\=AA,DD\=BB,DD\=CC,
...
(Isatom=yes,sub_atom(Sample, 31,1,_,DE),num(DE))),
DE\=DA,DE\=DB,DE\=DC,DE\=DD,
DE\=AE,DE\=BE,DE\=CE,

%% DF
(((Isatom=no;Length<33),num(DF));
(Isatom=yes,sub_atom(Sample, 32,1,_,DF),num(DF))),
...
(Isatom=yes,sub_atom(Sample, 33,1,_,DG),num(DG))),
DG\=DA,DG\=DB,DG\=DC,DG\=DD,DG\=DE,DG\=DF,
DG\=AG,DG\=BG,DG\=CG,

%% DH
(((Isatom=no;Length<35),num(DH));
(Isatom=yes,sub_atom(Sample, 34,1,_,DH),num(DH))),
DH\=DA,DH\=DB,DH\=DC,DH\=DD,DH\=DE,DH\=DF,DH\=DG,
DH\=AH,DH\=BH,DH\=CH,

%% DI
(((Isatom=no;Length<36),num(DI));
(Isatom=yes,sub_atom(Sample, 35,1,_,DI),num(DI))),
...
(Isatom=yes,sub_atom(Sample, 36,1,_,EA),num(EA))),
EA\=AA,EA\=BA,EA\=CA,EA\=DA,
EA\=DB,EA\=DC,
%% EB
(((Isatom=no;Length<38),num(EB));
(Isatom=yes,sub_atom(Sample, 37,1,_,EB),num(EB))),
EB\=EA,
EB\=AB,EB\=BB,EB\=CB,EB\=DB,
EB\=DA,EB\=DC,
%% EC
(((Isatom=no;Length<39),num(EC));
(Isatom=yes,sub_atom(Sample, 38,1,_,EC),num(EC))),
EC\=EA,EC\=EB,
EC\=AC,EC\=BC,EC\=CC,EC\=DC,
EC\=DA,EC\=DB,
%% ED
(((Isatom=no;Length<40),num(ED));
(Isatom=yes,sub_atom(Sample, 39,1,_,ED),num(ED))),
ED\=EA,ED\=EB,ED\=EC,
ED\=AD,ED\=BD,ED\=CD,ED\=DD,
ED\=DE,ED\=DF,
%% EE
(((Isatom=no;Length<41),num(EE));
(Isatom=yes,sub_atom(Sample, 40,1,_,EE),num(EE))),
...
(Isatom=yes,sub_atom(Sample, 54,1,_,GA),num(GA))),
GA\=AA,GA\=BA,GA\=CA,GA\=DA,GA\=EA,GA\=FA,

%% GB
(((Isatom=no;Length<56),num(GB));
(Isatom=yes,sub_atom(Sample, 55,1,_,GB),num(GB))),
GB\=GA,
GB\=AB,GB\=BB,GB\=CB,GB\=DB,GB\=EB,GB\=FB,

%% GC
(((Isatom=no;Length<57),num(GC));
(Isatom=yes,sub_atom(Sample, 56,1,_,GC),num(GC))),
GC\=GA,GC\=GB,
...
(Isatom=yes,sub_atom(Sample, 63,1,_,HA),num(HA))),
HA\=AA,HA\=BA,HA\=CA,HA\=DA,HA\=EA,HA\=FA,HA\=GA,
HA\=GB,HA\=GC,
%% HB
(((Isatom=no;Length<65),num(HB));
(Isatom=yes,sub_atom(Sample, 64,1,_,HB),num(HB))),
HB\=HA,
...
(Isatom=yes,sub_atom(Sample, 71,1,_,HI),num(HI))),
...
(Isatom=yes,sub_atom(Sample, 78,1,_,IG),num(IG))),
...
(Isatom=yes,sub_atom(Sample, 79,1,_,IH),num(IH))),
...
(Isatom=yes,sub_atom(Sample, 80,1,_,II),num(II))),
...
write("###Start\n"),
term_string(AA,AAstring),term_string(AB,ABstring),term_string(AC,ACstring),term_string(AD,ADstring),term_string(AE,AEstring),term_string(AF,AFstring),term_string(AG,AGstring),term_string(AH,AHstring),term_string(AI,AIstring),write("\n"),
term_string(BA,BAstring),term_string(BB,BBstring),term_string(BC,BCstring),term_string(BD,BDstring),term_string(BE,BEstring),term_string(BF,BFstring),term_string(BG,BGstring),term_string(BH,BHstring),term_string(BI,BIstring),write("\n"),
term_string(CA,CAstring),term_string(CB,CBstring),term_string(CC,CCstring),term_string(CD,CDstring),term_string(CE,CEstring),term_string(CF,CFstring),term_string(CG,CGstring),term_string(CH,CHstring),term_string(CI,CIstring),write("\n"),
term_string(DA,DAstring),term_string(DB,DBstring),term_string(DC,DCstring),term_string(DD,DDstring),term_string(DE,DEstring),term_string(DF,DFstring),term_string(DG,DGstring),term_string(DH,DHstring),term_string(DI,DIstring),write("\n"),
term_string(EA,EAstring),term_string(EB,EBstring),term_string(EC,ECstring),term_string(ED,EDstring),term_string(EE,EEstring),term_string(EF,EFstring),term_string(EG,EGstring),term_string(EH,EHstring),term_string(EI,EIstring),write("\n"),
term_string(FA,FAstring),term_string(FB,FBstring),term_string(FC,FCstring),term_string(FD,FDstring),term_string(FE,FEstring),term_string(FF,FFstring),term_string(FG,FGstring),term_string(FH,FHstring),term_string(FI,FIstring),write("\n"),
term_string(GA,GAstring),term_string(GB,GBstring),term_string(GC,GCstring),term_string(GD,GDstring),term_string(GE,GEstring),term_string(GF,GFstring),term_string(GG,GGstring),term_string(GH,GHstring),term_string(GI,GIstring),write("\n"),
term_string(HA,HAstring),term_string(HB,HBstring),term_string(HC,HCstring),term_string(HD,HDstring),term_string(HE,HEstring),term_string(HF,HFstring),term_string(HG,HGstring),term_string(HH,HHstring),term_string(HI,HIstring),write("\n"),
term_string(IA,IAstring),term_string(IB,IBstring),term_string(IC,ICstring),term_string(ID,IDstring),term_string(IE,IEstring),term_string(IF,IFstring),term_string(IG,IGstring),term_string(IH,IHstring),term_string(II,IIstring),write("\n"),
write("###End\n"),
